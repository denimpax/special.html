...
$(document).ready(function(){
	...
	// Sub menu
	$('body').on('click', '.js-show-menu', function(){
		$(this).removeClass('js-show-menu').addClass('active js-hide-menu');
		$('.header-menu').show();
	});

	$('body').on('click', '.js-hide-menu', function(){
		$(this).removeClass('active js-hide-menu').addClass('js-show-menu');
		$('.header-menu').hide();
	});
	...
	// 	$.magnificPopup.open({
	// 		items: {
	// 			src: '../data/popup/registration.html',
	// 			type: 'ajax',
	// 			alignTop: true,
	// 			overflowY: 'scroll',
	// 		}
